 ...
 */
final class Version20210809160239 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD date_ajout DATETIME NOT NULL, ADD date_paiement DATETIME DEFAULT NULL, ADD options LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP date_ajout, DROP date_paiement, DROP options');
