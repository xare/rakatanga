 ...
 */
final class Version20210505162253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel ADD duration INT NOT NULL, ADD level VARCHAR(3) NOT NULL, ADD date DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel DROP duration, DROP level, DROP date');
    }
}
