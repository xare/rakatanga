 ...
 */
final class Version20210601144332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel DROP price_driver, DROP price_codriver');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel ADD price_driver NUMERIC(10, 2) NOT NULL, ADD price_codriver NUMERIC(10, 2) NOT NULL');
    }
}
