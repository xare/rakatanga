 ...
 */
final class Version20210503103256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE travel_translation (id INT AUTO_INCREMENT NOT NULL, lang_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, INDEX IDX_ABEA73E0B213FA4 (lang_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE travel_translation ADD CONSTRAINT FK_ABEA73E0B213FA4 FOREIGN KEY (lang_id) REFERENCES lang (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE travel_translation');
