 ...
 */
final class Version20210803110006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE options (id INT UNSIGNED AUTO_INCREMENT NOT NULL, travel_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, intro TEXT NOT NULL, prix NUMERIC(10, 2) NOT NULL, INDEX IDX_D035FA87ECAB15B3 (travel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
