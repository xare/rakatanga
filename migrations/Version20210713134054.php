 ...
 */
final class Version20210713134054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dates ADD requested_docs LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dates DROP requested_docs');
