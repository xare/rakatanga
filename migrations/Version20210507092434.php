 ...
 */
final class Version20210507092434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel CHANGE departure_date departure_date DATETIME DEFAULT NULL, CHANGE arrival_date arrival_date DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel CHANGE departure_date departure_date DATE DEFAULT NULL, CHANGE arrival_date arrival_date DATE DEFAULT NULL');
    }
}
