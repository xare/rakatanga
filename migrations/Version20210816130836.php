 ...
 */
final class Version20210816130836 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation_options (reservation_id INT NOT NULL, options_id INT UNSIGNED NOT NULL, INDEX IDX_B7A041023ADB05F1 (options_id), INDEX IDX_B7A04102B83297E7 (reservation_id), PRIMARY KEY(reservation_id, options_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
