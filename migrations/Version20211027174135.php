 ...
 */
final class Version20211027174135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD idcard VARCHAR(10) DEFAULT NULL, ADD address VARCHAR(255) DEFAULT NULL, ADD postcode VARCHAR(6) DEFAULT NULL, ADD city VARCHAR(255) DEFAULT NULL, ADD country VARCHAR(255) DEFAULT NULL, ADD nationality VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP idcard, DROP address, DROP postcode, DROP city, DROP country, DROP nationality');
    }
}
