 ...
 */
final class Version20210709112102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE travellers (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, langue VARCHAR(2) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, position VARCHAR(255) NOT NULL, assurance VARCHAR(255) NOT NULL, vols VARCHAR(255) DEFAULT NULL, date_ajout DATETIME NOT NULL, INDEX IDX_BE969DD4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE travellers ADD CONSTRAINT FK_BE969DD4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
