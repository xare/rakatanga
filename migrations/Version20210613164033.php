 ...
 */
final class Version20210613164033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD main_photo_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1A7BC5DF9 FOREIGN KEY (main_photo_id) REFERENCES media (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_64C19C1A7BC5DF9 ON category (main_photo_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category DROP FOREIGN KEY FK_64C19C1A7BC5DF9');
        $this->addSql('DROP INDEX UNIQ_64C19C1A7BC5DF9 ON category');
        $this->addSql('ALTER TABLE category DROP main_photo_id');
