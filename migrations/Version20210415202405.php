 ...
 */
final class Version20210415202405 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category_translation (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, lang_id INT NOT NULL, title VARCHAR(255) NOT NULL, intro VARCHAR(255) DEFAULT NULL, slug VARCHAR(100) NOT NULL, INDEX IDX_3F2070412469DE2 (category_id), INDEX IDX_3F20704B213FA4 (lang_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE category_translation ADD CONSTRAINT FK_3F20704B213FA4 FOREIGN KEY (lang_id) REFERENCES lang (id)');
