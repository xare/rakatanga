 ...
 */
final class Version20221111093655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE codespromo CHANGE reservations_id reservation_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE codespromo CHANGE reservation_id reservations_id INT DEFAULT NULL');
