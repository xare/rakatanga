 ...
 */
final class Version20210505155955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel_translation ADD duration INT NOT NULL, ADD level VARCHAR(3) NOT NULL, ADD url VARCHAR(255) NOT NULL, ADD summary LONGTEXT NOT NULL, ADD intro LONGTEXT NOT NULL, ADD description LONGTEXT NOT NULL, ADD itinerary LONGTEXT NOT NULL, ADD practical_info LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE travel_translation DROP duration, DROP level, DROP url, DROP summary, DROP intro, DROP description, DROP itinerary, DROP practical_info');
    }
}
